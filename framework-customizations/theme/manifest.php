...
$manifest['id']                  = 'exciter';
$manifest['skin']                = 'main';
$manifest['name']                = esc_html__( 'Bearsthemes', 'exciter' );
$manifest['uri']                 = 'http://theme.bearsthemes.com/wordpress/exciter-demo/';
$manifest['description']         = esc_html__( 'WordPress Theme', 'exciter' );
