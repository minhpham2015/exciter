...
$fullwidth = isset($exciter_options['portfolio_fullwidth'])&&$exciter_options['portfolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($exciter_options['portfolio_sidebar_width']) ?  $exciter_options['portfolio_sidebar_width']: 3;
...
$portfolio_titlebar = isset($exciter_options['portfolio_titlebar']) ? $exciter_options['portfolio_titlebar']: true;
if($portfolio_titlebar) exciter_titlebar();
?>
