...
$fullwidth = isset($exciter_options['single_portolio_fullwidth'])&&$exciter_options['single_portolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($exciter_options['single_portolio_sidebar_width']) ?  $exciter_options['single_portolio_sidebar_width']: 3;
$related_post = isset($exciter_options['single_portfolio_related_post']) ? $exciter_options['single_portfolio_related_post']: true;
$related_post_label = isset($exciter_options['single_portfolio_related_post_label'])&&$exciter_options['single_portfolio_related_post_label'] ? $exciter_options['single_portfolio_related_post_label']: esc_html__('Portfolio Related', 'exciter');
$related_post_count = (int) isset($exciter_options['single_portfolio_related_post_count'])&&$exciter_options['single_portfolio_related_post_count'] ? $exciter_options['single_portfolio_related_post_count']: 3;
$related_post_per_row = (int) isset($exciter_options['single_portfolio_related_post_per_row'])&&$exciter_options['single_portfolio_related_post_per_row'] ? $exciter_options['single_portfolio_related_post_per_row']: 3;
...
$single_portfolio_titlebar = isset($exciter_options['single_portfolio_titlebar']) ? $exciter_options['single_portfolio_titlebar']: true;
if($single_portfolio_titlebar) exciter_titlebar();
?>
