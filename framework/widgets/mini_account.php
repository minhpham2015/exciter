<?php
class exciter_Mini_Account_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'mini_account_widget', // Base ID
                __('Mini Account', 'exciter'), // Name
                array('description' => __('Mini Account Widget', 'exciter'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('login_text')); ?>"><?php _e('Login Text:', 'exciter');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('logout_text')); ?>"><?php _e('Logout Text:', 'exciter');
		 ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('cl_class')); ?>"><?php _e('Extra Class:', 'exciter'); ?></label>
...
/**
 * Class exciter_Mini_Acount_Widget
 */
function exciter_register_mini_account_widget() {
    register_widget('exciter_Mini_Account_Widget');
}
add_action('widgets_init', 'exciter_register_mini_account_widget');
?>
