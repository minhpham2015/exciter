<?php
class exciter_Icon_Info_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'icon_info_widget', // Base ID
                __('Icon Info', 'exciter'), // Name
                array('description' => __('Icon Info Widget', 'exciter'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('font_icon')); ?>"><?php _e('Icon:', 'exciter');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('meta_info')); ?>"><?php _e('Text:', 'exciter');
		 ?></label>
 ...
 */
function exciter_register_icon_info_widget() {
    register_widget('exciter_Icon_Info_Widget');
}
add_action('widgets_init', 'exciter_register_icon_info_widget');
?>
