...
$fullwidth = isset($exciter_options['single_team_fullwidth'])&&$exciter_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($exciter_options['single_team_sidebar_width']) ?  $exciter_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($exciter_options['single_team_titlebar']) ? $exciter_options['single_team_titlebar']: true;
if($single_team_titlebar) exciter_titlebar();
?>
