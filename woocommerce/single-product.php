...
$fullwidth = isset($exciter_options['product_fullwidth'])&&$exciter_options['product_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($exciter_options['product_sidebar_width']) ?  $exciter_options['product_sidebar_width']: 3;
