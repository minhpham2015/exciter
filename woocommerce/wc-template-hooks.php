...
add_filter( 'loop_shop_per_page', 'exciter_loop_shop_per_page', 20 );
function exciter_loop_shop_per_page( $cols ) {
	global $exciter_options;
	$cols = (int) isset($exciter_options['shop_product_per_page']) ? $exciter_options['shop_product_per_page']: 10;
	return $cols;
}
