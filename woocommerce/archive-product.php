...
$fullwidth = isset($exciter_options['shop_fullwidth'])&&$exciter_options['shop_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($exciter_options['shop_sidebar_width']) ? $exciter_options['shop_sidebar_width']: 3;
$shop_top_bar = isset($exciter_options['shop_top_bar']) ? $exciter_options['shop_top_bar']: false;
$shop_product_per_row = (int) isset($exciter_options['shop_product_per_row']) ? $exciter_options['shop_product_per_row']: 3;
